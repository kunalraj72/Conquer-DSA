// Last updated: 11/06/2026, 01:43:54
1class Solution {
2
3    public void findPermutations(boolean[] used, int[] nums, List<Integer> ds, List<List<Integer>> ans){
4
...
26        List<Integer> ds = new ArrayList<>();
27        boolean[] used = new boolean[nums.length];
28        Arrays.sort(nums); //to handle duplicates
29        findPermutations(used, nums, ds, ans);
30        return ans;
31    }
32}