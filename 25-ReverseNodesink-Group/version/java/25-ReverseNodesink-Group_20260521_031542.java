// Last updated: 21/05/2026, 03:15:42
1/**
...
13    private int listLen(ListNode head) {
14        int count = 0;
15        while (head != null) {
16            count++;
17            head = head.next;
...
48        if (head == null || k > listLen(head)) return head;
49
...
66            if(prevGroupTail != null) prevGroupTail.next = newHead;
67            head.next = nextNode;
