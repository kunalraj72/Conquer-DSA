// Last updated: 15/07/2026, 03:28:47
1class MyStack {
2
...
18        for(int i = 1; i < size; i++){ //Last Wale ko chor k sabko queue k front se back me shift kar do (update top as well), at the end stack top will be the front of queue, we can simply do q.poll().
